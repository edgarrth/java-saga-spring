...
public class EventStoreAdapter implements EventStorePort {
 private final EventStoreJpaRepository repo; private final ObjectMapper mapper;
 public EventStoreAdapter(EventStoreJpaRepository repo,ObjectMapper mapper){this.repo=repo;this.mapper=mapper;}
